...
// forEach did't return any think
fruits.forEach((val , idx) => {  // callback function don't have name 
    console.log(`value of index: ${idx} of fruits is ${val}`)
})

function printMe(val , idx){
    console.log(`${idx} : ${val}`)
}
...
// did't return anythink
personDetail.forEach( function (person){ 
    console.log(`person name: ${person.name} , language : ${person.language}`)
})