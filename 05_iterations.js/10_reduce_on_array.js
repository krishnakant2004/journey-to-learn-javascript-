...
// reduce iterate over array and reduce the array to the single value
// two parameters -> (acc , curr) ,acc -> store the result up to the current value , curr -> current value

// ?  total cart price
let total_price = cart.reduce((acc , curr) => curr.total + acc , 0)
