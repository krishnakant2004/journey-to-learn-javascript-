...
// return all  porson which have language Sindhi
let sindhi_person = personDetail.filter((person) => {
    if(person.language.toLowerCase() == "sindhi") return true
    return false
})

for(let p of sindhi_person){
    console.log(p.name)
}